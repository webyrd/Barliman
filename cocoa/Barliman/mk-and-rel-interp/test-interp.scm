...
(time
  (test "synthesize stutter"
     ...
     ;; result!
     '((((define append (lambda (l s) (if (null? l) s (cons (car l) (append (cdr l) s))))) (define stutter_n (lambda (n xs) (if (null? xs) '() (append (replicate n (car xs)) (stutter_n n (cdr xs)))))) (define replicate (lambda (n x) (match n (`Z '()) (`(S ,n^) (cons x (replicate n^ x))))))))))
 )
